...
void knapSack_cps_cont4(void **arg_list,struct __cont_env *contn_env,int phase_num);
void knapSack_cps_cont3(void **arg_list,struct __cont_env *contn_env,int phase_num);
void knapSack_cps(void **arg_list,struct __cont_env *contn_env,int phase_num);
...
void parallel_for_body1_cps(void **arg_list,struct __cont_env *contn_env,int phase_num)
{
  ...
  knapSack_cps(arg_list,contn_env,phase_num);
}
...
//0 to N-1 row index
  ...
  knapSack_cps_cont_env3 -> cont_fn = knapSack_cps_cont3;
  uwomp_barrier(knapSack_cps_cont_env3,phase_num);
}
