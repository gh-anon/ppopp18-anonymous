...
#pragma omp single 
{
    ...
    __parreg_arglist = ((void **)(malloc(8 * sizeof(void *))));
...
#pragma omp for  private(i)
  for (i = 0; i < processes; i++) {
    if (arg_list_parallel_for_body1_0[i] == NULL) {
      arg_list_parallel_for_body1_0[i] = malloc(8 * sizeof(void *));
    }
    arg_list_parallel_for_body1_0[i][0] = i;
    arg_list_parallel_for_body1_0[i][1] = p;
    arg_list_parallel_for_body1_0[i][2] = pt;
    arg_list_parallel_for_body1_0[i][3] = sval;
