...
void OmpRegBody1_cps_cont3(void **arg_list,struct __cont_env *contn_env,int phase_num);
void OmpRegBody1_cps(void **arg_list,struct __cont_env *contn_env,int phase_num);
void parallel_for_body1_cps_cont2(void **arg_list,struct __cont_env *contn_env,int phase_num);
...
//  }
  ...
  uwomp_barrier(parallel_for_body1_cps_cont_env2,phase_num);
}
